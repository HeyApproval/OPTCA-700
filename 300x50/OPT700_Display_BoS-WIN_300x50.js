...
// stage content:
(lib.OPT700_Display_BoSWIN_300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(242.4,27,1.3179,1.3179);
	...
	this.shape_1.setTransform(242,25);
	...
	this.shape_2.graphics.f("#D9F6FA").s().p("A3bD6IAAnzMAu3AAAIAAHzg");
...
p.nominalBounds = new cjs.Rectangle(-56.7,24.5,357.2,26);
// library properties:
lib.properties = {
